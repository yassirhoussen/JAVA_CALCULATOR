...
public class ListenerProxies {
	...
	public static ActionListener actionListener(final Object target, String method) {
		...
		return (ActionListener) Proxy.newProxyInstance(target.getClass().getClassLoader(), INTERFACES, handler);
	}
